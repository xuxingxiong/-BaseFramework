	...
	public String getPageStr() {
		...
		if (totalResult > 0) {
			...
			if (currentPage == 1) {
				...
				sb.append("	<li><input type=\"number\" value=\"\" id=\"toGoPage\" min=\"1\" max=\"" + totalPage
						+ "\" oninput=\"if(value>" + totalPage + ") value=" + totalPage
						+ "; else if (value<1) value=1 \" style=\"width:50px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
				sb.append(
			...
			sb.append("		url = url + page + \"&" + (entityOrField ? "showCount" : "page.showCount") + "=" + showCount
					+ "&flag=\"+(document.getElementById(\"flag\")?document.getElementById(\"flag\").value:\"\");\n");
			...
			sb.append("		url = url + \"1&" + (entityOrField ? "showCount" : "page.showCount")
					+ "=\"+value+\"&flag=\"+(document.getElementById(\"flag\")?document.getElementById(\"flag\").value:\"\");\n");
			sb.append("		document.forms[0].action = url;\n");
			sb.append("		document.forms[0].submit();\n");
			sb.append("	}else{\n");
			sb.append("		var url = document.location+'';\n");
