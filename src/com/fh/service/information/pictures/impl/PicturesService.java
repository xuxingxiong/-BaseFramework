...
public class PicturesService implements PicturesManager {
	 ...
	 * @throws Exception
	 */
	public void refsave(PageData pd)throws Exception{
		dao.save("PicturesMapper.refsave", pd);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PageData> getRefListById(String id) throws Exception {
		return (List<PageData>)dao.findForList("PicturesMapper.getRefListById", id);
	}

	@Override
	public PageData getRefById(PageData pd) throws Exception {
		return (PageData)dao.findForObject("PicturesMapper.getRefById", pd);
	
		
	}

	@Override
	public void delrefTp(PageData pd) throws Exception {
		dao.delete("PicturesMapper.delrefTp", pd);
	}
