...
public class LoginController extends BaseController {
	...
	public void setAttributeToAllDEPARTMENT_ID(Session session, String USERNAME) throws Exception{
		...
		// TODO 数据表不完整，OA_STAFF,OA_DEPARTMENT
...
//		}
	...
	public ModelAndView defaultPage(Page page) throws Exception{
		...
		page.setPd(pd);
		pd.put("reminds",remindService.list(page));
		mv.addObject("pd",pd);
	 ...
	 * @throws Exception 
	 */
	@RequestMapping(value="/removeRemind")
	public Object removeRemind() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		pd.put("USERID", pd.getString("USERID"));
		remindService.remove(pd);
