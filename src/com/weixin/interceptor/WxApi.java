...
public class WxApi {
	...
	//获取一个素材
	private static final String GET_ONE_MATERIAL = "https://api.weixin.qq.com/cgi-bin/material/get_material?access_token=%s";
	//上传多媒体资料接口
	...
	//上传永久素材：图文内部图片
	private static final String UPLOAD_NEWS_PIC = "https://api.weixin.qq.com/cgi-bin/media/uploadimg?access_token=%s";
	...
	//删除永久素材
	private static final String DEL_MATERIAL ="https://api.weixin.qq.com/cgi-bin/material/del_material?access_token=%s";
	
	//修改图文消息
	private static final String UPD_NEWS = "https://api.weixin.qq.com/cgi-bin/material/update_news?access_token=%s";
	
	//获取修改图文消息接口
	public static String getUpdateNewsUrl(String token){
		return String.format(UPD_NEWS, token);
	}
	//获取删除素材接口
	public static String getDelMaterialUrl(String token){
		return String.format(DEL_MATERIAL, token);
	}
	...
	// 获取单个素材接口
	public static String getOneMaterialUrl(String token) {
		return String.format(GET_ONE_MATERIAL, token);
	}
	//获取上传图文消息接口
	...
	//获取上传图文消息接口
	public static String getUploadNewsPicUrl(String token){
		return String.format(UPLOAD_NEWS_PIC, token);
	}
	//群发接口
