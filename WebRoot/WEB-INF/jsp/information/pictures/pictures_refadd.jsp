...
<body class="no-skin">
	<div class="main-container" id="main-container">
		<div class="main-content">
			...
			<input type="hidden" name="id" id="refid" value="${id}" />
		    <div id="wrapper">
		        <div id="container">
		            <!--头部，相册选择和格式选择-->
		            <div id="uploader">
		                ...
		                <div><span>备注：</span><input type="text" name="discribe" id="refdiscribe" /></div>
	...
	<!-- webuploader上传插件js -->
   	...
   	<script type="text/javascript" src="plugins/webuploader/refupload.js"></script>
