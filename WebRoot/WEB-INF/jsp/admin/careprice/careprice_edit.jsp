		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="careprice/${msg}.do" name="Form" id="Form" method="post">
						<input type="hidden" name="ID" id="ID" value="${pd.ID}"/>
						<input type="hidden" name="SUB_ID" id="ID" value="${pd.SUB_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:25%;text-align: right;padding-top: 13px;">服务名称:</td>
								<td><input type="text" name="NAME" id="NAME" value="${pd.NAME}" maxlength="24" placeholder="这里输入服务名称" title="服务名称" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">单价（成本价）:</td>
								<td><input type="text" name="PURCHACE_PRICE" id="PURCHACE_PRICE" value="${pd.PURCHACE_PRICE}" maxlength="12" placeholder="这里输入单价（成本价）" title="单价（成本价）" style="width:98%;"/></td>
							</tr>
							<tr>
