				...
				<div class="row">
					...
					<form action="category/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
	     						<td style="width:100px;text-align: right;padding-top: 13px;">分类表示图片:</td>
	 							<td style="text-align:left;">
		  							<img id="imgAD" src="<%=basePath%>uploadFiles/uploadImgs/${pd.ICON}" alt="" width="100"
		  							style="display: <c:if test="${pd.ICON == null }">none</c:if>" /> 
		  							<input type="hidden" name="ICON" id="ICON" value="${pd.ICON}" /><!-- 图片成功上传后的url -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function chooseImg() {
			...
			var diag = new top.Dialog();
			 diag.Drag=false;
			 diag.Title ="选择图片";
			 diag.URL = '<%=basePath%>pictures/listChoose.do?flag='+'category';
			 diag.Width = 800;
			 diag.Height = 600;
