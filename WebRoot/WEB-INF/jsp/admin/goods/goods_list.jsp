...
<body class="no-skin">
												...
												<c:if test="${QX.cha == 1 }">
													<c:forEach items="${varList}" var="var" varStatus="vs">
														<tr>
															...
															<td class='center'>${var.CATEGORY_NAME_1}</td>
															<td class='center'>${var.CATEGORY_NAME_2}</td>
									...
									<table style="width: 100%;">
										<tr>
											<td style="vertical-align: top;"><c:if
													test="${QX.add == 1 }">
													<a class="btn btn-mini btn-success" onclick="add();">新增商品</a>
												</c:if> <c:if test="${QX.add == 1 }">
													<a class="btn btn-mini btn-success"
														href="<%=basePath%>store/list.do">返回店铺</a>
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=false;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>goods/goAdd.do?STORE_ID='+$("#storeId").val();
			 diag.Width = 600;
			 diag.Height = 500;
