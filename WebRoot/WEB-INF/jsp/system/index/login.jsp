			...
			<form action="" method="post" name="loginForm"
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="text" name="loginname" tabindex="1" id="loginname" value="" placeholder="请输入用户名" />
						</div>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="password" name="password" tabindex="2" id="password" placeholder="请输入密码" class="keypad" value=""/>
						</div>
					</div>
				</div>
				<div style="float:right;padding-right:10%;">
					...
					<div style="float: left;">
						<input name="form-field-checkbox" id="saveid"  tabindex="4" type="checkbox"
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;" class="codediv">
							<input type="text" name="code"  tabindex="3" id="code" class="login_code"
								style="margin-top: 2px;height:13px; padding-top:4px;" />
						</div>
						<div style="float: left;">
